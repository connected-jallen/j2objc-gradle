...
class PodspecTask extends DefaultTask {
    ...
    static String genPodspec(String podname, String publicHeadersDir, String resourceDir,
        ...
        return "Pod::Spec.new do |spec|\n" +
               "  spec.authors = {'Josh Allen' => 'jallen@connectedlab.com', 'Mathieu Gosbee' => 'mgosbee@connectedlab.com' }\n" +
               "  spec.license = 'Yes'\n" +
               "  spec.homepage = 'http://connectedlab.com'\n" +
               "  spec.source = { :git => 'https://github.com/connected-lab/eiffel', :tag => 'master' }\n" +
               "  spec.name = '$podname'\n" +
               "  spec.version = '1.0'\n" +
